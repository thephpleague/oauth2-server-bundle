...
final class LegacyOAuth2TokenTest extends TestCase
{
    public function testTokenSerialization(): void
    {
        ...
        $providerKey = 'main';
        $token = new LegacyOAuth2Token($serverRequest, $user, $rolePrefix, $providerKey);

        /** @var LegacyOAuth2Token $unserializedToken */
